...
def _create_core_schema(conn: sqlite3.Connection) -> None:
    conn.executescript(
        ...
        CREATE TABLE IF NOT EXISTS memory_items (
            ...
            task_segments_json TEXT NOT NULL DEFAULT '[]',
...
def _ensure_memory_columns(conn: sqlite3.Connection) -> None:
    ...
    item_migrations = {
        ...
        "areas_json": "ALTER TABLE memory_items ADD COLUMN areas_json TEXT NOT NULL DEFAULT '[]'",
        "task_segments_json": "ALTER TABLE memory_items ADD COLUMN task_segments_json TEXT NOT NULL DEFAULT '[]'",
